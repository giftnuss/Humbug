...
function use_class($class, $desc = '')
{
    $pass = class_exists($class, true);
    return _proclaim($pass, $desc == '' ? "class_exists $class" : $desc);
}

function use_interface($interface, $desc = '')
{
    $pass = interface_exists($interface, true);
    return _proclaim($pass, $desc == '' ? "interface_exists $interface" : $desc);
}
